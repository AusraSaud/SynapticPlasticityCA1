...
def Fig4A():
    ...
    for freq in frequencies:
        synparams = {}
        results = PylediPlasticity.run_stdp_tests_static(pairings = 20, frequency = freq, post_spikes = 1, synparams = synparams, stdp_range=[10], first_post=True, save_last_record_only=True)
